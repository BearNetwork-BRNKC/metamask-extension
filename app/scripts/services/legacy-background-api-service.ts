...
export class LegacyBackgroundApiService {
  ...
  readonly #onPermittedAccountsAdded: (payload: {
    origin: string;
    newCaipAccountIds: CaipAccountId[];
  }) => void;
   ...
   * @param options.onPermittedAccountsAdded - A callback invoked after permitted accounts are extended for an origin.
   */
  constructor({
    messenger,
    infuraProjectId,
    ...
    this.#onPermittedAccountsAdded = onPermittedAccountsAdded;
   ...
   * given addresses, then invokes the `onPermittedAccountsAdded` callback for
   * any newly permitted CAIP account ids.
   *
